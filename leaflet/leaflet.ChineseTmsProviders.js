...
L.TileLayer.ChinaProvider.providers = {
    TianDiTu: {
        ...
        key: "23a3eba8bcc868bf6be5a6d65b2ec3d3"
    },
    ...
    Google: {
        Normal: {
            Map: "//gac-geo.googlecnapps.cn/maps/vt?lyrs=m@189&gl=cn&x={x}&y={y}&z={z}"
        },
        Satellite: {
            Map: "//gac-geo.googlecnapps.cn/maps/vt?lyrs=s@189&gl=cn&x={x}&y={y}&z={z}",
            Annotion: "//gac-geo.googlecnapps.cn/maps/vt?lyrs=y@189&gl=cn&x={x}&y={y}&z={z}"
        },
        Subdomains: []
    },
