...
function loadmap() {
	...
	var d = new BMap.Icon("https://jsd.onmicrosoft.cn/gh/Saturn87930/test00/leaflet/images/cross.svg", new BMap.Size(48, 48), {
	    // 假设该SVG图标的视觉中心在其底部中央，我们需要向上偏移一半的高度
	    imageOffset: new BMap.Size(12, 12) 
	});
